...
class FamilyStructure:
    def __init__(self, last_name):
        ...
        self._members = [
            {"id": self._generateId(), "first_name": "Jhon", "last_name": "Jackson", "age": 33, "lucky_numbers": [7, 13, 22]},
    ...
    def add_member(self, member):
        ...
        another_member = {"id":member.get("id", self._generateId()), "last_name": self.last_name}
        member.update(another_member)
